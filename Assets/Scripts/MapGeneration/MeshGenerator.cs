...
public class MeshGenerator : MonoBehaviour {
	...
	void TriangulateSquare (Sqaure square) {
	...
	public class SquareGrid {
		...
		public SquareGrid (int[,] map, float squareSize) {
			...
			squares = new Sqaure[nodeCountX - 1, nodeCountY -1];
			for ( int x = 0; x < nodeCountX - 1; x++) {
				for(int y =0; y < nodeCountY - 1; y++) {
					squares[x,y] = new Sqaure(controlNodes[x, y + 1], controlNodes[x + 1, y + 1], controlNodes[x + 1, y], controlNodes[x, y]);
				}
			}
		}
	}
	...
	public class Sqaure {
		...
		public Sqaure(ControlNode _topLeft, ControlNode _topRight, ControlNode _bottomRight, ControlNode _bottomLeft) {
			topLeft = _topLeft;
			topRight = _topRight;
